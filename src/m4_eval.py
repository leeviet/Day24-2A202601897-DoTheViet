...
def evaluate_ragas(questions: list[str], answers: list[str],
    ...
    try:
        ...
        # Use Groq for LLM, and local SentenceTransformers for Embeddings (to avoid OpenAI charges)
        groq_llm = ChatOpenAI(
        ...
        return {"faithfulness": result.get("faithfulness", 0.0), 
                ...
                "context_recall": result.get("context_recall", 0.0), "per_question": per_question}
...
def failure_analysis(eval_results: list[EvalResult], bottom_n: int = 10) -> list[dict]:
    ...
    return results_with_scores[:bottom_n]
